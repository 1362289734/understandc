...
import mbm.entity.User;
import mbm.service.UserService;
...
//        }else if (resourcePath.startsWith("css")||resourcePath.startsWith("images")||resourcePath.startsWith("js")
...
//    }
    private void responseResource(MbmRequest mbmRequest) throws IOException {
        ...
        if (resourcePath.contains("form_post_fail.html")) {
            // 获取异常信息描述
            InputStream resourceAsStream = com.sun.net.httpserver.HttpServer.class.getClassLoader()
                    .getResourceAsStream(resourcePath);
        ...
        InputStream resourceAsStream = HttpServer.class.getClassLoader().getResourceAsStream(resourcePath);
